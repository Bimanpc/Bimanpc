...
$Label2.text                     = "SentryOne Server Name by BillPS"
...
$Label3.text                     = "SentryOne DB Name PSBilly"
...
$LoadDB.Font                       = 'Microsoft Sans Serif,12'
...
$Label7.Font                = 'Microsoft Sans Serif,12'
